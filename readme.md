...
# 📖 Tic Tac Toe <a id="about-project"></a>
...
```
git clone git@github.com:Luffytaro22/Tic-Tac-Toe.git
```
...
### Deployment
You can deploy this project with [This Link](https://luffytaro22.github.io/Tic-Tac-Toe/dist/)
